...
class JMPGCF(object):
    def __init__(self, data_config):
        ...
        self.opt_1 = tf.compat.v1.train.AdamOptimizer(learning_rate=self.lr).minimize(self.loss_1)
        ...
        self.opt_2 = tf.compat.v1.train.AdamOptimizer(learning_rate=self.lr).minimize(self.loss_2)
        ...
        self.opt_3 = tf.compat.v1.train.AdamOptimizer(learning_rate=self.lr).minimize(self.loss_3)
