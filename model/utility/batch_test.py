...
import sys
sys.path.append(r'C:\Users\ZhongXuanyue\Documents\机器学习\codes_dcfb32d64cb9e5faf834\JMP-GCF-master\model\evaluator')
import evaluator
...
def test(sess, model, users_to_test, train_set_flag=0, stage=1):
    ...
    for u_batch_id in range(n_user_batchs):
        ...
        batch_result = evaluator.eval_score_matrix_foldout(rate_batch, test_items, max_top)  # (B,k*metric_num), max_top= 20
